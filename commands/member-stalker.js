...
const options = [
    { label: 'Warring Stats', description: 'Get warring stats', value: 'warring', selection: 'rankedwarhits,raidhits,territoryclears,territoryjoins,rankedwarhits,rankedwarringwins,respectforfaction' },
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const endDateTimestamp = inputDate.endOf('day').unix();
        ...
        const memberOutput = await memberInformation(homeFaction, apiSelection, message, startDateTimestamp, endDateTimestamp, exportCSV);
